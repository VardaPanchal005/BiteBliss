  ...
  return (
    <div className='bg-white'>
      ...
      <div className='text-center px-6'>
        <div className='mt-20 p-5 text-5xl font-bold px-0'>Apple Pie</div>
        <div className=' container max-w-md  border-white mx-auto text-left'>This amazing apple pie recipe belonged to my grandmother. I have never seen another one quite like it! It will always be my favorite and has won several first place prizes in local competitions. It makes the perfect dessert for family dinners or during the holidays, topped with whipped cream or ice cream, or alongside a slice of Cheddar cheese.</div>
       
    <div className="container max-w-md py-4 text-center mx-auto">
  <img src={pie} className='w-full h-auto mb-8' alt="Pav Bhaji" />
